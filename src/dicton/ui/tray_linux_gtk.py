"""Linux GTK system tray via AyatanaAppIndicator3."""
...
class GtkSystemTray(SystemTray):
    ...
    def _run_gtk(self) -> None:
        try:
            ...
            icon_path = _generate_icon(self.STATE_COLORS["IDLE"])
    ...
    def _update_state(self, state: SessionState) -> bool:
        ...
        label = self.STATE_LABELS.get(name, name)
